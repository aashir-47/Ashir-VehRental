        ...
        <div class="container mb-5">
          <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="col-lg-12 text-center mt-2">
                      <?php $city_id=0; if(isset($_GET['city_id'])) $city_id=$_GET['city_id']; ?>
                      ...
                      <div class="col-12 d-flex">
                        <div class="col-4">
                          <div class="input-group">
                            <select class="form-control border-dark" name="cat_id" id="cat_id" value="<?=$city_name?>" required>
                            <option class="text-danger"  value="0" >---- No Type Selected ----</option>
                                <?php
                            ...
                            <div class="input-group-append">
                              <button type="submit" id="searchBtn" class="btn btn-success btn-block" >Search By Type</button>
                            </div>
                          </div>
                        </div>
                        <div class="col-4">
                          <div class="input-group">
                            ...
                            <div class="input-group-append">
                              <button type="submit" id="searchBtn" class="btn btn-success btn-block" >Search By City</button>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            if($cat_id>0 && $city_id>0  )
              $sql.=" WHERE vehicles.cat_id='$cat_id' AND vehicles.city_id='$city_id'  "; 
            elseif($cat_id>0  )
              $sql.=" WHERE vehicles.cat_id='$cat_id'  ";   
            elseif($city_id>0  )
              $sql.=" WHERE vehicles.city_id='$city_id' ";
            $result = mysqli_query($conn, $sql);
            ?>
                    ...
                    <?php $i = 0; while ($row = mysqli_fetch_array($result)): ?>
                      <div class="col-lg-3 mb-1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-2">
                              <a href="book-vehicle.php?bookingAddId=<?=$row['veh_id']?>"  class="btn btn-sm btn-success"><i class="fa fa-check"></i> Book Vehicle</a>
