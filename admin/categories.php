              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 text-center mt-3" id="heading2 ">
                    <h1><p class="animate__animated animate__fadeInUp" >ADMIN PANEL</p></h1>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                   <div class="col-lg-12 text-center mt-3" id="heading2 ">
                    <h1><p class="animate__animated animate__fadeInUp" >Manage City</p></h1>
                  </div>
                  <div class="col-lg-12 text-center mt-2">
                    <a data-fancybox data-type="ajax" data-src="add-city.php" class="btn btn btn-success align-items-center" href="javascript:;"><i class="fas fa-feather-alt"></i> Add New City</a>
                  </div>
                    <form id="form" action="" method="">
                      <table class="table table-striped table-bordere text-lg-center align-text-bottom" id="myTable">
                        <thead>
                        ...
                        <tbody>
                          ...
                          <tr> 
                            <td scope="row"><?=(++$i)?></td>
                                <td><?=$row['city_name']?></td>
                                <td>
                                  <a data-fancybox data-type="ajax" data-src="add-city.php?cityEditId=<?=$row['city_id']?>" href="javascript:void();" class="btn btn-sm btn-primary fancybox.ajax"><i class="fa fa-edit fa-fw"></i></a>
                                  <a href="manage-cities.php?cityDelId=<?=$row['city_id']?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this city ?');"><i class="fa fa-trash fa-fw"></i></a>
                                </td>
                          </tr>
                          <?php  endwhile; ?>
                        </tbody> 
