              ...
              <div class="card">
                <div class="card-body">
                  <div class="col-lg-12 text-center mt-3" id="heading2 ">
                    <h1><p class="animate__animated animate__fadeInUp" >Admin Control Pannel</p></h1>
                  </div>
                </div>
              </div>
            </div>
                   ...
                   <div class="m-3">
                    ...
                    <form id="form" action="" method="">
                      <table class="table table-striped table-bordere text-lg-center align-text-bottom" id="myTable">
                        ...
                        <tbody>
                          <?php 
                            $sql="SELECT * FROM users WHERE user_type='1' ORDER BY profile_status ASC ";
                          ...
                          <tr> 
                            ...
                            <td><?=$row['address']?></td>
                            <td>
                              <?php if ($row["profile_status"]==0): ?>
                                <a href="manage-users.php?userApproveId=<?=$row['user_id']?>"  class="btn btn-sm btn-success mx-2">Approve</a>
                                <a href="manage-users.php?userDelId=<?=$row['user_id']?>"  class="btn btn-sm btn-danger mx-2">Reject</a>
                              <?php elseif ($row["profile_status"]>0): ?>
                                ...
                                <a href="manage-users.php?userDelId=<?=$row['user_id']?>" class="btn btn-sm btn-success" onclick="return confirm('Are you sure you want to delete this user profile ?');"><i class="fa fa-trash fa-fw"></i></a>
                              <?php endif ?>
