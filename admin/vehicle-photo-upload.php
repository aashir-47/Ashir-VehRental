...
$vehPhotoId=0;
if(isset($_GET['vehPhotoId']))
{
	$veh_id=$_GET['vehPhotoId'];
}
?>
<div>
	<div class="col-lg-12" style="padding:0px;">
		<div class="card">
			...
			<div class="card-body" style="min-width:450px;">
				...
				<form name='myForm' id='myForm' action="manage-vehicles.php" method="post" enctype="multipart/form-data">
					<div class="form-row justify-content-lg-center justify-content-md-center">
						<div class="form-group col-lg-12 col-md-12 col-sm-12" >
							<strong><label for="c_name">Select Vehicle Photo</label></strong></br></br>
					...
					<div class="form-row justify-content-lg-left justify-content-md-left">
						<div class="form-row col-lg-12 col-md-12 col-sm-12 mt-5">
							<input type="hidden" name="vehPhotoId" value="<?=$veh_id?>"/>
