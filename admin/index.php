              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="intro-body">
                    <p class="intro-title-top"> Dear <b><?=(isset($_SESSION['ADMIN_ROLE'])?ucfirst($_SESSION['ADMIN_ROLE'])." (".ucfirst($_SESSION['SESS_ADNAME']).")":"Guest")?></b></p>
                    <h3 class="intro-title mb-4">
                      <span class="color-b">Welcome To </span>
                      <br> Online Vehicle Rental System
                    </h3>
                  </div>
                </div>
              </div>
